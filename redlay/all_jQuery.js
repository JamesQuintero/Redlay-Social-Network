...
//    return "<table style='width:100%;' id='"+body_id+"'><tbody><tr><td style='width:400px;'>"+body+"</td> <td style='vertical-align:top;'><table><tbody><tr><td><table><tbody><tr><td>"+profile_picture+"</td><td><table style='height:70px;'><tbody><tr><td>"+name+"</td></tr><tr><td>"+badge_body+"</td></tr></tbody></table></td></tr></tbody></table></td></tr> <tr><td>"+button+"</td></tr><tr><td>"+description+"</td></tr><tr><td>"+timestamp+"</td></tr>  </tbody></table></td></tr></tbody></table>"+line_break;
    return "<table style='width:100%;' id='"+body_id+"'><tbody><tr><td style='width:400px;'>"+body+"</td> <td style='vertical-align:top;'><table style='height:100%;display:inline-block;'><tbody><tr><td style='vertical-align:top;height:100px;'><table><tbody><tr><td>"+profile_picture+"</td><td><table style='height:50px;'><tbody><tr><td style='height:20px;'>"+name+"</td></tr><tr><td style='vertical-align:bottom;'>"+num_adds+"</td></tr></tbody></table></td><tr><td><table style='width:100%;'><tbody>"+badge_body+"</tbody></table></td><td></td></tr></tr></tbody></table></td></tr><tr><td style='vertical-align:top;'>"+description+"</td></tr><tr><td style='height:35px;'>"+buttons+"</td></tr><tr><td style='height:20px;'>"+timestamp+"</td></tr>  </tbody></table></td></tr></tbody></table>"+line_break;
}
function add_new_group()
{
    var new_group=$('#add_new_group_input').val();
...
function display_groups(item_id, type)
{
    ...
    }, function(output)
    {
       ...
       //adds new group input
       $('#'+item_id+'_body').html($('#'+item_id+'_body').html()+"<tr class='select_body_options_row' id='"+item_id+"_audience_row_"+x+"'></tr>");
       $('#'+item_id+'_audience_row_'+x).html("<td class='audience_selection_checkbox_unit' id='"+item_id+"_audience_selection_checkbox_"+x+"'></td><td class='select_body_option_unit' id='"+item_id+"_audience_selection_text_"+x+"' colspan='2'> <input class='input_box' type='text' placeholder='Add group' id='add_new_group_input'/> </td>");
       ...
       $('#add_new_group_input').keydown(function(e)
        {
            var key = (e.keyCode ? e.keyCode : e.which);
            if(key == '13')
            {
                add_new_group();
                display_groups(item_id, type);
            }
        });
    }, "json");
}
       ...
       $('#add_new_group_input').keydown(function(e)
        {
            ...
            {
                add_new_group();
                display_groups(item_id, user_id);
            }
        });
...
function convert_image(text, type)
{
    ...
    if(final_text.toLowerCase().indexOf('http://')!=-1||final_text.toLowerCase().indexOf('https://')!=-1)
    {
            ...
            {
                console.log("Doesn't go right to end");
...
function get_post_functions(like, dislike, comment, timestamp)
{
    if(like!=''&&dislike!=''&&comment!='')
        return "<table class='post_functions_table'><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;'>"+like+"</td><td class='post_functions_unit' style='display:inline-block;float:left;'>"+dislike+"</td><td class='post_functions_post_comment_unit'style='display:inline-block;float:left;'>"+comment+"</td><td style='text-align:right'>"+timestamp+"</td></tr></tbody></table>";
    else if(like==''&&dislike!=''&&comment!='')
        return "<table class='post_functions_table'><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;'>"+dislike+"</td><td class='post_functions_post_comment_unit' style='display:inline-block;float:left;'>"+comment+"</td><td style='text-align:right'>"+timestamp+"</td></tr></tbody></table>";
    else if(like!=''&&dislike==''&&comment!='')
        return "<table class='post_functions_table'><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;'>"+like+"</td><td class='post_functions_post_comment_unit' style='display:inline-block;float:left;'>"+comment+"</td><td style='text-align:right'>"+timestamp+"</td></tr></tbody></table>";
    else if(like!=''&&dislike!=''&&comment=='')
    {
        if(timestamp=="")
            ...
            var border="";
        return "<table class='post_functions_table'><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;'>"+like+"</td><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;"+border+"'>"+dislike+"</td><td class='post_functions_unit' style='border:none;'></td><td style='text-align:right'>"+timestamp+"</td></tr></tbody></table>";
    }
    else if(like==''&&dislike!=''&&comment=='')
    {
        if(timestamp=="")
            ...
            var border="";
        return "<table class='post_functions_table'><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;"+border+"'>"+dislike+"</td><td style='text-align:right'>"+timestamp+"</td></tr></tbody></table>";
    }
    else if(like!=''&&dislike==''&&comment=='')
    {
        if(timestamp=="")
            ...
            var border="";
        return "<table class='post_functions_table'><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;"+border+"'>"+like+"</td><td style='text-align:right'>"+timestamp+"</td></tr></tbody></table>";
    }
    else if(like==''&&dislike==''&&comment!='')
    {
        if(timestamp=="")
            ...
            var border="";
        return "<table class='post_functions_table'><tbody><tr><td class='post_functions_post_comment_unit' style='display:inline-block;text-align:left;float:left;"+border+"'>"+comment+"</td><td style='text-align:right'>"+timestamp+"</td></tr></tbody></table>";
    }
...
//        else
//            var border="";
        return "<table class='comment_functions_table'><tbody><tr><td><table><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;'>"+like+"</td><td class='post_functions_unit' style='display:inline-block;float:left;"+border+"'>"+dislike+"</td></tr></tbody></table></td><td style='text-align:right;'>"+timestamp+"</td></tr></tbody></table>";
    }
...
//        else
//            var border="";
        return "<table class='comment_functions_table'><tbody><tr><td><table><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;"+border+"'>"+dislike+"</td></tr></tbody></table></td><td style='text-align:right;'>"+timestamp+"</td></tr></tbody></table>";
    }
    else if(like!=''&&dislike=='')
    {
//        if(timestamp=="")
...
//        else
//            var border="";
        return "<table class='comment_functions_table'><tbody><tr><td><table><tbody><tr><td class='post_functions_unit' style='display:inline-block;text-align:left;float:left;"+border+"'>"+like+"</td></tr></tbody></table></td><td style='text-align:right;'>"+timestamp+"</td></tr></tbody></table>";
    }
    else
...
function display_profile_picture_menu()
{
    display_dim();
    
    $('.alert_box_inside').html("<form action='change_profile_picture.php' method='post' enctype='multipart/form-data'><table style='text-align:center;width:100%;'><tbody><tr><td><input class='file_button' id='profile_picture_settings' type='file' name='image' style='color:black;font-size:14px;font-weight:normal;'/><div id='loading_gif_profile_picture' class='loading_gif_body'><img class='load_gif' src='http://pics.redlay.com/pictures/load.gif' /></div></td></tr><tr><td><input class='button red_button' id='submit_profile_picture' type='submit' name='submit_profile_picture' value='Upload' /></td></tr></tbody></table>").css('width', '400px');
    
    $('#loading_gif_profile_picture').hide();
    $('#submit_profile_picture').attr('onClick', "$('#loading_gif_profile_picture').show();");
...
function black_theme_over()
{
    $('#black_redlay_unit').css('width', '37%');
    $('#white_redlay_unit').css('width', '29%');
}
function theme_out()
{
    $('#black_redlay_unit').css('width', '33%');
    $('#white_redlay_unit').css('width', '33%');
}
function white_theme_over()
{
    $('#black_redlay_unit').css('width', '29%');
    $('#white_redlay_unit').css('width', '37%');
}
function pull_theme()
{
    $('#redlay_theme_box').animate(
    {
        bottom:0
    }, 350, 
    function()
    {
        $('#redlay_theme_text_unit').attr('onClick', 'push_theme();');
    });
}
function push_theme()
{
    ...
    function()
    {
       $('#redlay_theme_text_unit').attr('onClick', 'pull_theme();'); 
    });
}
function redlay_white_theme()
{
    $.post('redlay_theme.php',
    {
        theme: 'white'
    }, function(output)
    {
...
function redlay_aluminum_theme()
{
    $.post('redlay_theme.php',
    {
        theme: 'aluminum'
...
function redlay_custom_theme()
{
    ...
    }, function(output)
    {
        if(output=='')
        {
            window.location.replace("http://www.redlay.com/custom_theme.php");
        }
        else
            display_error(output, 'bad_errors');
    });
...
function post(user_id)
{
    ...
    var num=0;
    var num2=0;
    while($('#post_audience_selection_box_checkbox_'+num2).length)
    {
        if($('#post_audience_selection_box_checkbox_'+num2).data('checked')=='yes')
        {
            audience_options_list[num]=$('#post_audience_selection_box_checkbox_'+num2).data('group_name');
            num++;
        }
        num2++;
    }
...
//
function record_page_load_time(page, time)
{
    $.post('record_time.php',
    {
        page: page,
        time: time
    }, function(output)

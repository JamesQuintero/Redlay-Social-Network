                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="theme_info_div">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="title_color">Lights</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p class="text_color">This background features a background picture of blurred calm lights. The header features rainbow colored flames.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>

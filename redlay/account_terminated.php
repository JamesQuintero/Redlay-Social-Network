...
<html>
    ...
    <body>
        <div id="top">
            <?php if($_SESSION['id']!=null) include('top.php'); else if(isset($_SESSION['page_id'])) include('top_page.php'); else include('index_top.php'); ?>
        </div>
        <div id="main">
            <div id="account_terminated_content" class="content box">
                <p class="text_color" style="text-align:center;">Account Has Been Terminated.</p>
            </div>
        </div>
    </body>
</html>
